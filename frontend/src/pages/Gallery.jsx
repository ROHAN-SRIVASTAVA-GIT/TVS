      ...
      {loading ? (
        ...
        <div className="gallery-grid">
          {images.map((image) => (
            ...
            >
              <img src={getImageUrl(image.image_url)} alt={image.title} onError={(e) => { e.target.src = demoImages[0].image_url; }} />
      ...
      {selectedImage && (
        <div className="lightbox" onClick={() => setSelectedImage(null)}>
          <div className="lightbox-content" onClick={(e) => e.stopPropagation()}>
            ...
            <img src={getImageUrl(selectedImage.image_url)} alt={selectedImage.title} onError={(e) => { e.target.src = demoImages[0].image_url; }} />
